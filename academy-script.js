...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mobile buttons
    const mobilePrevButton = document.querySelector('.col-md-12.d-flex.mt-4 .custom-carousel-btn:first-child');
    const mobileNextButton = document.querySelector('.col-md-12.d-flex.mt-4 .custom-carousel-btn:last-child');
